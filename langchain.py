#!/usr/bin/env python3
"""
RAG Movie Script Generator – ULTRA-LIGHT CPU-ONLY
NO transformers, NO huggingface_hub, NO LLM
Just: chunk → embed → retrieve → build prompt
"""
...
def chunk_script_with_scenes(text: str, title: str, year: str, genre: str) -> List[Dict]:
    ...
    # scenes list looks like: [before, "INT.", scene, "EXT.", scene, ...]
...
def main():
    ...
    print(" ULTRA-LIGHT RAG (NO LLM, CPU-ONLY)")
    print(f" Time: {now()}")
    ...
    print(f"\n{bcolors.OKGREEN}{'='*70}")
    print(" COPY THIS PROMPT INTO YOUR LLM")
    print(f"{'='*70}{bcolors.ENDC}\n")
    print(final_prompt)
